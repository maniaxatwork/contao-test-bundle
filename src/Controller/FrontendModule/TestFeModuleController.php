...
namespace Maniaxatwork\ContaoTestBundle\Controller\FrontendModule;
...
/**
 * Class TestFeModuleController
 *
 * @FrontendModule(TestFeModuleController::TYPE, category="test_fe_modules", template="mod_test_fe_module")
 */
class TestFeModuleController extends AbstractFrontendModuleController
{
    public const TYPE = 'test_fe_module';
